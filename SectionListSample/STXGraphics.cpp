...
void CSTXD2DGraphics::DrawImage(int x, int y, int width, int height, CSTXGraphicsImage *pImage, CSTXGraphicsImageFormat* pImageFormat)
{
	...
	if (pD2DImage)
	{
		...
		_renderTarget.QueryInterface<ID2D1DeviceContext>(&spDeviceContext);
...
void CSTXD2DGraphics::DrawRichText(ITextServices *pTextService, int x, int y, int width, int height)
{
	...
	CComQIPtr<ID2D1GdiInteropRenderTarget> spGDIRenderTarget;
	_renderTarget.QueryInterface<ID2D1GdiInteropRenderTarget>(&spGDIRenderTarget);
	HDC hDCRender = NULL;
